...
const Timeline = () => {
  return (
    <>
      <div className="mx-auto w-1/2 my-28 flex items-center justify-center timeline-container hide">
        <ul className="timeline">
          ...
          <li>
            ...
            <div className="timeline-end timeline-box">3rd Milestone</div>
            <hr />
          </li>
          <li>
            <hr />
            <div className="timeline-start timeline-box">Mission</div>
            <div className="timeline-middle">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
